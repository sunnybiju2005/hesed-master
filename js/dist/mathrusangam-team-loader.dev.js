...
$(document).ready(function () {
  loadMathrusangamTeamToPage(); // Listen for Realtime Database changes to update Mathrusangam team dynamically
...
function loadMathrusangamTeamToPage() {
  var teamContainer, mathrusangamTeam;
  return regeneratorRuntime.async(function loadMathrusangamTeamToPage$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          teamContainer = $('.mathrusangam-team-members');
        ...
        case 7:
          mathrusangamTeam = _context.sent;
        ...
        case 11:
          ...
          console.error('Error loading Mathrusangam team:', _context.t0);
